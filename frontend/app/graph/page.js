  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-6 select-none">
      ...
      <div className="text-center">
        ...
        <p className="text-alabaster-200 text-xs">Paste a GitHub repo URL above and click Analyze</p>
      </div>
    ...
    <AuthGuard>
      <div className="flex flex-col h-screen bg-black overflow-hidden">
        ...
        <main className="flex-1 relative overflow-hidden">
          {graphLoading && (
            <div className="absolute inset-0 flex items-center justify-center z-10 bg-black bg-opacity-60">
              <div className="flex items-center gap-2 bg-prussian border border-prussian-600 px-5 py-3 rounded-lg">
                ...
                <span className="text-alabaster-300 text-sm font-mono">Analyzing repository…</span>
              </div>
            </div>
          )}
          ...
          {!graphLoading && nodes.length === 0 && <EmptyState />}
